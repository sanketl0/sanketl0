# 💫 About Me:
<h3>"I'm a passionate software engineer at Coderize Technologies, specializing in Angular, Python, and Django. Currently, I'm a developer on a live project where I'm responsible for creating a dashboard using Angular for the frontend and developing backend APIs in Django. I'm dedicated to delivering high-quality code and contributing to the project's success. At Coderize, I'm constantly learning new techniques and collaborating with talented developers to create innovative solutions. Let's build something amazing together!"</h3><br>
